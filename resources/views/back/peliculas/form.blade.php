<div class="form-group">
    ...
    <small id="titulo" class="form-text text-muted">Aquí va el título del peliculas</small>
</div>
...
<div class="form-group">
    ...
    <small id="Descripción" class="form-text text-muted">Descripción del peliculas</small>
</div>
